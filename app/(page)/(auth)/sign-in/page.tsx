  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 space-y-5">
        ...
        <div className="space-y-1">
          ...
          <div className="relative">
            <Input id="si-pw" name="password" type={showPassword ? "text" : "password"} required
              autoComplete="current-password" placeholder="••••••••" className="pr-10" disabled={anyLoading} />
      ...
      <p className="text-center text-sm text-muted-foreground">
        ...
        <Link href="/sign-up" className="text-red-500 font-semibold hover:underline">Sign up</Link>
      </p>
    </div>
  );
}
