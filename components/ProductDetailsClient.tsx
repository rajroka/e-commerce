          ...
          <div className="flex flex-col justify-center p-6 sm:p-10 lg:p-16 bg-white">
            <div className="space-y-6">
              ...
              <div className="flex items-baseline gap-4 pt-4">
                <span className="text-3xl font-black text-gray-900 tracking-tighter">${discountedPrice}</span>
                <span className="line-through text-gray-400 text-lg font-medium">${product.price.toFixed(2)}</span>
              </div>
              ...
              <div className="pt-8 flex gap-3">
                <button
                  ...
                  className="flex-1 bg-gray-800 rounded hover:bg-black text-white py-4 text-sm font-bold uppercase tracking-[0.2em] transition-all duration-300 active:scale-[0.98]"
                >
