  ...
  return (
    <main className="min-h-screen bg-gray-50 px-6 p-8 md:p-12 lg:p-16 py-10">
      <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-4">
        <h1 className="text-2xl font-medium text-gray-800">Trending Products</h1>
        <Link
          href="/products"
                ...
                <div className="p-4 flex flex-col flex-grow">
                  ...
                  <div className="mt-4 flex gap-2">
                    <button
                      ...
                      className="flex-1 bg-gray-800 hover:bg-gray-900 text-white py-2 rounded text-sm  flex items-center justify-center gap-2 font-medium transition"
                    >
                    ...
                    <Link
                      ...
                      className="flex-1 border border-gray-300 bg-white text-sm hover:bg-gray-100 text-gray-800 py-2 rounded flex items-center justify-center gap-2 font-medium transition"
                    >
                      View
                    </Link>
                  </div>
