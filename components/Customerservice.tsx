  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 text-gray-900">
        ...
        <article className="flex flex-col items-center text-center gap-1 p-6 py-4  border rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
        ...
        <article className="flex flex-col items-center text-center gap-1 p-6 border rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300">
